...
const ExperienceCard: React.FC<Props> = ({
    ...
    // Framer Motion's useInView to detect when the section is in view
    const inView = useInView(ref, {
        amount: 0.8, // Start animation when 80% of the section is in view
