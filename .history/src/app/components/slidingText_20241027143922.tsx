...
reverse,subText }) => {
    ...
    const x = useTransform(scrollYProgress, [0, isMobile ? 0.5 : 0.6], [!reverse ? 350 : -350, 0]); // Adjust as needed
    const opacity = useTransform(scrollYProgress, [0, isMobile ? 0.4 : 0.55 ], [0,  1]);
