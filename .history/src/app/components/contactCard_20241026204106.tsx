...
>Thomaslmusial@gmail.com</motion.p>
        ...
        <motion.p
            initial="hidden"
            animate={tiltFinished ? "animate" : "hidden"}
            variants={textVariants(false, 0)}
        >
            I am ready to work and learn about how the software
            industry operates and contribute to awesome projects
        </motion.p>
            {/* <motion.p
...
{/* <motion.img
                ...
                src={social.image}
                initial="initial"
                animate={tiltFinished ? "animate" : "initial"}
                variants={socialVariants(index * 0.25)}
            /> */}
                     </Link>
                ))}
            </div>
