...
reverse,subText }) => {
    ...
    const x = useTransform(scrollYProgress, [0, isMobile ? 0.8 : 0.6], [!reverse ? 350 : -350, 0]); // Adjust as needed
    ...
    return (
        <div ref={targetRef}>
            <motion.h2
                ...
                text-3xl sm:text-4xl md:text-5xl lg_text-6xl font-semibold text-center relative transition-colors
                mb-8"
