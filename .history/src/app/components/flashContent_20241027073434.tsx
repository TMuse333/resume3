        ...
        <>
            <section className='mx-auto w-screen max-w-[1200px] relative mb-8'>
                <AppearingGradient
                    ...
                    subText='I am currently learning to combine ma'
                />
                <MotionImage
                    src={src}
                    alt={alt}
                ...
                />
                <motion.p className='px-4 mx-auto md:w-[80%] md:text-lg rounded-2xl text-white text-left sm:text-center'>
                    ...
                    <Link href='best-web-design-halifax'>
                        <motion.button className='bg-[#00bfff] rounded-xl p-3 text-white'>
