            ...
            >
                ...
                >
                    {images.map((image, index) => (
                        <div
                            className="w-[80vw]   rounded-2xl max-h-[800px] relative flex-shrink-0   mr-10
                            pb-6 max-w-[500px] overflow-y-scroll overflow-x-hidden"
                            key={index}
                        ...
                        >
                            ...
                            <Image
                                src={image.src}
                                alt={image.alt}
                                className="relative ml-auto mr-auto mt-4 
                                z-[5] object-contain w-[60vw]  transition-all   rounded-lg
                                h-[90%]
                                max-h-[500px]"
                                width={1000}
                                height={55}
