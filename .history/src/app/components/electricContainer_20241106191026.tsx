...
const ElectricContainer:React.FC<Props> = ({
    ...
    return (
      ...
      />
        <section className="relative  text-gray-500 bg-gradient-to-b from-[#00bfff] to-[#679aab] w-[95vw] mx-auto max-w-[900px]
         rounded-2xl overflow-hidden h-[90vh] max-h-[500px]">
                    
                    <IoIosArrowForward className="absolute text-black text-3xl sm:text-5xl top-[40%] right-0 text-2xl hover:text-blue-200
          hover:scale-[1.15] z-[12] transition-all" onClick={nextTestimonial} />
        <IoIosArrowBack className="absolute top-[40%] left-0 
          hover:text-blue-200 text-3xl z-[12] text-black
