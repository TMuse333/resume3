...
bg-[#00bfff] bg-opacity-[0.5]">
     <span className="mb-1.5 w-[30vw] mx-auto text-center mt-4 inline-block rounded-full bg-gray-600/50 px-3 py-1.5 text-sm">
    ...
    <p className="font-medium mt-2">You can contact me below</p>
    <p className="mt-2">Phone:902-999-1006</p>
    <p className="mt-2">Email: thomaslmusial@gmail.com</p>
    </section>
