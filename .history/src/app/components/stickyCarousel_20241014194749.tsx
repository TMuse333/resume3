...
const StickyCarousel: React.FC<Props> = ({ title, description, images }) => {
  ...
  return (
    ...
    <AppearingGradient
    text=''
    subText='My primary skill is creating visually appealing, animated websites with next js. I have spent 1100 hours since august 2023 (3-4 hours of coding everyday) honing this craft. Here are some of the aspects of my front end engineering skills.'
    />
     </div>
    <section
      ref={containerRef}
