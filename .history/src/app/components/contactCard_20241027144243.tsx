...
bg-[#00bfff] bg-opacity-[0.5] pb-24 ">
    ...
    sm:text-lg md:text-xl">If you are ready to have
    ...
    <p className="mt-2 sm:text-lg md:text-xl">Phone: 902-999-1006</p>
    <p className="mt-2 sm:text-lg md:text-xl">Email: thomaslmusial@gmail.com</p>
    </section>
