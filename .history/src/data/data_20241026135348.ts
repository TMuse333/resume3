...
export const imageBox1Props = {
    ...
    description:My design skills are solid, and as I continue refining my Next.js expertise, I’m expanding into the realm of data-driven marketing. Recognizing the high value of actionable insights, I’m now focused on integrating social media APIs to gather meaningful data, which can drive lead generation strategies for clients. By combining visually engaging, high-performance designs with data analysis, my goal is to create Next.js applications that not only enhance user experience but also support business growth through targeted lead generation and customer engagement. This dual approach allows me to deliver powerful tools that help businesses reach their goals more effectively`,
