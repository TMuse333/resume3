 ...
 const textAndList = [
    ...
    },
    {
      ...
      },
      {
        ...
        description:'To make more complex apps, I use the context variables so multiple components can use the same data, I did this a lot in the restaurant. I have also developed a system where'
      }
  ];
