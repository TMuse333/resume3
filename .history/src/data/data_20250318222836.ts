...
export const codingCarousel = [
 ...
 const textAndList = [
    ...
    },
    {
        title: "Seo work",
        description:
          "With next js, I have gotten to the first page of google twice, through using semRush to search for keywords, then implementing those keywords throughout the app and also writing blog posts week",
      },
  ];
