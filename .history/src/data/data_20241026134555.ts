...
export const imageBox1Props = {
    ...
    description:`My design skills are very solid but gathering data
    from others, it seems marketing is valued a lot, so I am
    now learning how to use social media apis to gather data
    and find leads for people so that my next js apps will be
    visually appealing and help people get more business.`,
