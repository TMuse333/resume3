 ...
 const textAndList = [
    {
      title: "Appealing Framer Motion Animations",
      description:
        "I have a background in animation, having created stop-motion films with Legos and iPads years ago. I bring those same principles to web design, using Framer Motion hooks like `animate` and `useScroll` to retain attention and make my websites stand out.",
    },
    {
      title: "Backend Capabilities",
      description:
