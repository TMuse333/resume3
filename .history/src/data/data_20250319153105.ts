...
export const experienceCard1 = {
    ...
    Three of my projects have been about real estate websites`,
 ...
 const textAndList = [
    {
      ...
      description:
        "My animations on all of my apps are done with framer motion, I've done multiple types of animations like"+
        "animating when inView or based of scrolling. I have also done sequenced based animating to make my apps retain attention and stand out."+
        "",
    },
    {
      title: "Backend Capabilities with node js",
      description:
        "Beyond frontend development with Next.js, I have experience using MongoDB for data handling, Nodemailer for sending emails, and Stripe for e-commerce integration. This allows me to build full-stack applications that are both functional and scalable.",
    },
    {
      title: "Fantastic Emulation Capabilities",
      description:
        "Creativity is about connecting ideas. If you show me a design you love, I can emulate it. I draw inspiration from top-tier websites like Apple and Dribbble, ensuring that my work is visually striking and highly functional.",
    },
    {
        title: "Seo work",
        description:
          "With next js, I have gotten to the first page of google twice, through using semRush to search for keywords, then implementing those keywords throughout the app and also writing blog posts weekly to stay on the first page.",
      },
      {
        title:'Context variables and reusable components',
        description:'To make more complex apps, I use the context variables so multiple components can use the same data, I did this a lot in the restaurant.'
      },
      {
        title:'Reusable components',
        description:'I have designed my components to be able to take in props so that I can reuse components and have quick'+
        " setup times."
      }
  ];
  
  export const codingAttributes = {
    src:'/focusFlow-brain-nobg.png',
    alt:'the focus flow brain',
    title:'General coding attributes',
    subTitle:'What are my skills?',
    description:'I have done lots of different designs and projects through out my react journey. Primaliry focusing on animations and creating visually appealing frontend projects, then making development time efficient and planning user experience. I have also spent time learning how to enhance performace of websites with dynmaic and lazy loading.',
    listAspects:textAndList
}
...
export const imageBox1Props = {
    title:'Becoming more useful: Using next js for marketing',
    description: `My design skills are strong, and as I 
    ...
    src:'/global-money.webp',
    alt:'An image of the earth with money around it'
}
...
export const bookCarousel = [
    {
        src:'/deep-work.webp',
        alt:'The book deep work by Cal newport',
        title:'Deep Work',
        description:`The second book I ever read and perhaps the most inflential and eye opening book I read, this book taught me the value of focused work and how to structure my days to get a lot of work done.
        This book caused me to structure my life to get 3-4 hours of deep work everyday which I still do to this day and have been doing so for 3 years now.`
    },
    {
        src:'/mastery.webp',
        alt:'The book Mastery by Robert Greene',
        title:'Mastery',
        description:'This book was very inspiring to me as it lays the foundations for becoming at master at your craft. It highlights the different phases a master goes through and challenges throughout the journey and how to overcome them. The book also describes how to find your purpose through your work which resonated very well with me.'
    },
    {
        src:'/atomic-habits.webp',
        alt:'Atomic Habits by James Clear',
        title:"Atomic Habits",
        description:`The book Atomic Habits taught me the importance of delayed gratification and how greatness takes time and results don't show up until you hit a certain breaking point, so just focus on the process. It also taught me how to design my environment for success.`
        
    },
    {
        src:'/decode-greatness.webp',
        alt:'Decoding Greatness by Ron Freidman',
        title:'Decoding Greatness',
        description:"The book decoding greatness was very eye opening to me on how great creations are really just connecting different things together in a new way. It taught me how you can reverse engineer anything then apply it in your own way to achieve anything you want. I use reverse engineering a lot with my websites and that is one of the ways I learned to make websites, by going to popular websites like Apple and emulating their components that I found appealing."
    }
...
export const imageTextBox2 = {
    title:'10 Years of competitive basketball',
    description:'I spent all of grade school playing competitive basketball, even going to New York, Boston and Toronto to play. This was very beneficial to me as it taught me how to be soley dedicated to a single task over a long period of time, how to deal with pressure and working in a team enviroment and many more things.'+
    'I will use all of these skills learned during my competitive playing days to help the team win',
    src:'/dunk.png',
    alt:'Thomas Musial dunking a basketball'
...
export const previousExperience = [
    {
        title:'10 Years of competitive basketball',
        src:'/dunk.png',
        description:'All throughout school I played competitve basektball. This taught me dedication, teamwork and how to perform under pressure. Once basketball ended I took all of that energy into coding and it has turned out great.',
        alt:'A picture of me dunking like a real one'
    },
    {
        title:'2 years of computer science at Dalhousie university',
        src:'/dalhousie.jpg',
        description:'I did two years of computer science at dalhousie. I learned the fundamentals of programming there. After the second year I determined it would be the correct decision to drop out and fully persue one programming framework and I chose react. For me it was absolutely the correct decision I am glad I did it.',
        alt:'A logo of dalhousie university'
    }
]
...
export const codingStats = {
    ...
    alt:'The focus flow brain',
    title:"Coding stats",
    description:"Hello I am Thomas. A react js developer who has spent the last year and a half learning react js through emulating popular websites and combing previous art experience."+
    "I typically code 3-4 hours a day and have been doing purley react since August 2023 after two years of computer science at dalhousie university",
    stats:[
        {
            number:'1200',
            name:'Hours of react development (self taught)'
        },
        {
            number:'47',
            name:'Projects in github'
        },
        {
            number:'8',
            name:'Websites done for clients'
        }
    ]
