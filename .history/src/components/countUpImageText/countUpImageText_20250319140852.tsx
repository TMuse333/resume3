    ...
    const fadeInVariants = (delay: number) => {
      ...
      return (
        <motion.section
          ...
          ref={ref}
          className="flex flex-col bg-gradient-to-b from-[#002B5B] via-[#004C8C] to-[#0066CC] mt-12 w-[97vw] rounded-2xl overflow-hidden md:flex-row-reverse mx-auto max-w-[1200px]
          text-gray-300"
        >
          {/* Title */}
          <motion.h2
            ...
            className="mx-auto text-3xl text-gray-300 font-bold text-center sm:text-4xl md:text-5xl mt-12 mb-4 md:hidden"
          >
            {title}
          </motion.h2>
          ...
          <section className="flex flex-col px-4 md:w-[48vw]">
            <motion.h2
              ...
              initial="initial"
              animate={inView ? "animate" : "initial"}
              className="mx-auto text-3xl text-white font-bold text-center sm:text-4xl md:text-5xl mt-12 mb-4 hidden md:block"
            >
              {title}
            </motion.h2>
            ...
            <motion.p
              ...
              initial="initial"
              animate={inView ? "animate" : "initial"}
              className="text-white md:px-4 font-semibold mb-6 mt-4 md:mt-0"
            >
              {description}
            </motion.p>
              ...
              <div className="text-2xl mb-6 flex flex-col justify-start items-start">
                {stats.map((stat, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="flex flex-col text-gray-200 items-center justify-center text-center ml-4 mb-6 md:ml-0 mr-auto"
                    >
                      <motion.p
