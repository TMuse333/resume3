    ...
    bg-gradient-to-b from-[#002B5B] via-[#004C8C] to-[#0066CC] mt-12">
      <section className="flex flex-col-reverse md:flex-row justify-around items-center max-w-[1200px] w-full">
        <section className="mb-16 text-center">
          ...
          md:w-[48vw]">
           I am ready to prove myself useful and learn some new coding skills.
            I have a lifetime of design experience and
            through out my life whenever I have put my 
            mind to something it has worked out well.
        ...
        <section className="mt-12 w-full max-w-[455px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="bg-gradient-to-b from-[#002B5B] via-[#004C8C] to-[#0066CC] p-3 rounded-xl text-white hover:text-[#4D8890] hover:bg-white transition-all"
            >
              Submit form
            </button>
          </form>
