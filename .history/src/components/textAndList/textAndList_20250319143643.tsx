...
parentInView
    ...
    return (
        ...
        <button
          className="w-full flex justify-between items-center text-left text-white p-4 font-semibold bg-gradient-to-tr from-[#0073E6] via-[#0073E6] to-[#0073E6]
...
const TextAndList:React.FC<Props> = ({
    ...
    //   }
      ...
      return (
        <section className="w-full py-12  bg-gradient-to-bl from-[#002B5B] via-[#004C8C] to-[#0066CC]
        ">
