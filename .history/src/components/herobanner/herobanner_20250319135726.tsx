...
import tom from '../../../public/full-smile.png'
...
const FullBodyHero = () => {
 ...
 max-w-[800px] 
        ...
        md:items-start  py-4">
          ...
          src={logo}
          alt="logo"
          className="w-[35vw] max-w-[200px] mx-auto z-[2]
          mb-[-2rem]
          md:mb-[-4rem] mt-[-2rem]
          ...
          Disciplined and creative frontend developer
...
flex-col-reverse md:flex-col">
         ...
         md:w-[50vw] mr-auto 
          ...
          "
          text="I am a react js developer who specializes in creating visually appealing
