...
import tom from '../../../public/smiley-tom-half.png'
...
>
  ...
  priority
    ...
    width={1300}
    alt="A full body image of Thomas Musial"
    className="hidden  md:block md:w-[55vw] rounded-2xl bg-red-200 max-w-[535px] object-contain mx-auto bg-gray-300 bg-transparent h-auto relative z-[3] mt-auto"
  />
</motion.div>
